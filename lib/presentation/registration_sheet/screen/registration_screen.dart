  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Container(
          color: colorScheme.surfaceContainerHighest, // 전체 배경 통일
          child: Column(
            children: [
              // AppBar 자체에서 배경색 제거 후 부모 배경과 통일
              AnimatedBuilder(
                animation: todoViewModel,
                builder: (context, child) {
                  return CustomerRegistrationAppBar(
              ...
              Form(
                ...
                child: CustomerInfoPart(
                  ...
                  backgroundColor: colorScheme.surface, // 배경 통일
                ),
              ),
              if (!_isReadOnly)
                Container(
                  color: colorScheme.surface, // 부모와 동일
