...
class FilterComingBirthUseCase {
  static Future<Map<ComingBirth, List<CustomerModel>>> call(
    ...
    final Map<ComingBirth, List<CustomerModel>> result = {
      ...
      ComingBirth.noBirthInfo: [], // 생일 정보 없는 고객 저장
    };
    ...
    for (final customer in customers) {
      ...
      if (birth == null) {
        result[ComingBirth.noBirthInfo]!.add(customer);
        continue;
      }
      ...
      if (birth.month == 2 &&
          birth.day == 29 &&
          !DateTime(today.year).isLeapYear()) {
