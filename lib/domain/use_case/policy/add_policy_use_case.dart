...
class AddPolicyUseCase extends BaseUseCase<PolicyRepository>{
  ...
  AddPolicyUseCase({required this.userKey, required this.customerKey, required this.policyData});
  @override
  Future call(PolicyRepository repository)async {
  return await repository.addPolicy(userKey: userKey, customerKey: customerKey, policyData: policyData);
  }
